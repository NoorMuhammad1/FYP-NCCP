        ...
        <div className="row">
          <div className="col-5">
            ...
            <div className="row mt-4">
              <div className="col-6">
                <FormControl variant="outlined" className="form-control">
                  <InputLabel id="demo-simple-select-outlined-label">Order ID</InputLabel>
                  <Select
                    labelId="demo-simple-select-outlined-label"
                    id="demo-simple-select-outlined"
                    value={age}
              ...
              <div className="col-6">
                <FormControl variant="outlined" className="form-control">
                  <InputLabel id="demo-simple-select-outlined-label">Payment Amount</InputLabel>
                  <Select
                    labelId="demo-simple-select-outlined-label"
                    id="demo-simple-select-outlined"
                    value={age}
                  ...
                  >
                    ...
                    <MenuItem value={5000}>5 thousand or above</MenuItem>
                    <MenuItem value={10000}>10 thousand or above</MenuItem>
                    <MenuItem value={15000}>15000 or above</MenuItem>
                  </Select>
                </FormControl>
              </div>
            </div>
