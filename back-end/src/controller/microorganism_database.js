...
exports.fetchData = async (req, res) => {
  ...
  await page.goto('https://kctc.kribb.re.kr/EN/search/resourceSearchResult?pageNumber=1&searchKeyword=Bacillus%20pakistanensis&category=&selectAll=false&dna=false&typeStrain=false&engOpen=yes&protect=N');
    const data = await page.evaluate(()=>{
    return  document.querySelector('#desktop_list > tr');
  });
  console.log({...data});
};
